...
public class SentimentAnalyzer : MonoBehaviour
{
	...
	private string _username = "80e7d2f9-415a-48e6-af67-3ab528e3097a";
	private string _password = "3wc5sB1n0WLd";
    ...
    void Start()
    {
        ...
        Credentials naturalLanguageUnderstandingCredentials = new Credentials()
        {
			...
			Username = "9ba6f8c6-91b4-4710-a81a-e4ada8b6fafb",
			Password = "XehD7kittPXo",
